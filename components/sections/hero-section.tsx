        ...
        <FadeIn delay={0.1} className="relative flex items-center justify-center lg:justify-end">
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[30px] border border-white/10 bg-black/20">
              ...
              <div className="absolute left-4 top-4 z-20 rounded-full border border-gold/30 bg-black/35 px-4 py-2 text-[11px] uppercase tracking-[0.26em] text-gold sm:left-6 sm:top-6">
                Nivel Leyenda
              </div>
              <div className="absolute bottom-4 left-4 z-20 rounded-full border border-white/12 bg-black/28 px-4 py-2 text-[10px] uppercase tracking-[0.28em] text-white/85 backdrop-blur-sm sm:bottom-6 sm:left-6">
                Official Many Ross Visual
              </div>
              <div className="relative aspect-[3/5] min-h-[760px] sm:aspect-[2/3] sm:min-h-[860px] md:min-h-[920px] lg:aspect-[4/5] lg:min-h-[860px] xl:min-h-[900px]">
                <Image
